...
% rlbpfusion perform segmentation using local linear regression with random
...
%   We only compute updateRegion of mvResult which are
%   initialized by majority voting. 
%
    rlbpImg=mvResult;
    ...
    for iSplit=1:nSplit
        ...
        [targetPatches,atlasPatches]=patchgeneration(atlasImages,atlasLabels,...
                                                         targetImage,updateRegionSplit,...
                                                         searchRadius,NumofMaxDimension,patchRadius);
...
% RLBP feature extraction
[atlasFea,targetFea]=randomLBP_features(atlasPatch,targetPatch, NumberofHiddenNeurons);
