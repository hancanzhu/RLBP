...
%featuregeneration genearte features from atlas and target image for
%segmentation
%   [targetFeatures,AtlasFeatures]=featuregeneration(atlasImages,atlasLabels,targetImage,
%   updateRegionSplit,searchRadius,patchRadius) generate featuers from
%   targetImage to form targetFeatures, generate features from
%   atlasImages and atlasLabels to form  AtlasFeatures.
