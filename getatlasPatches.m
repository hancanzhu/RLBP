function patchesAndLabels=getatlasPatches(atlasImages,atlasLabels,...
                                            xi,yi,zi,r)
%   patchesAndLabels=getatlasPatches(atlasImages,atlasLabels,...
%   xi,yi,zi,r) compute patches from atlasImages and atlasLabels at
%   position(xi,yi,zi)
